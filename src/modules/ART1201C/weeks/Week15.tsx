...
const Week15Page = () => {
  ...
  const weekData = {
    weekNumber: 15,
    title: "Final Portfolio and Course Reflection",
    description: "In this final week, we'll focus on assembling your design portfolio and reflecting on your growth throughout the course.",
    learningObjectives: [],
    assignments: [],
    resources: [],
    competencies: [],
